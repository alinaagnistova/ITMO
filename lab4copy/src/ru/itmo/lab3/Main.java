...
public class Main{
    public static void main(String[] args){
        BodyParts[] tmp = new BodyParts[5];
        tmp[0] = new BodyParts("Голова", BodyType.HEAD);
        tmp[1] = new BodyParts("Руки", "длинные", BodyType.ARMS);
        tmp[2] = new BodyParts("Шея", "новая", "бесконечно длинная",  BodyType.NECK, CharacteristicType.LIKE_A_MAST, LocationType.ANY);
        tmp[3] = new BodyParts("Лицо", BodyType.FACE);
        tmp[4] = new BodyParts("Глаза","во все", BodyType.EYES);
        ...
        try {
            ...
            System.out.println("У Алисы нет глаз, невозможно выполнить действие.");
        }
